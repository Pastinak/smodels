...
d = Particle(zParity=+1,_name = 'd',_pid = 1,qColor = 3,eCharge = -1./3,
             spin = 1./2,mass = 0.*GeV,_width = 0.*GeV)
u = Particle(zParity=+1,_name = 'u',_pid = 2,qColor = 3,eCharge = 2./3,
             spin = 1./2,mass = 0.*GeV,_width = 0.*GeV)
#2nd generation quarks
s = Particle(zParity=+1,_name = 's',_pid = 3,qColor = 3,eCharge = -1./3,
             spin = 1./2,mass = 0.*GeV,_width = 0.*GeV)
c = Particle(zParity=+1,_name = 'c',_pid = 4,qColor = 3,eCharge = 2./3,
             spin = 1./2,mass = 1.275*GeV,_width = 0.*GeV)
#3rd generation quarks
b = Particle(zParity=+1,_name = 'b-',_pid = 5,qColor = 3,eCharge = -1./3,
             spin = 1./2,mass = 4.66*GeV,_width = 0.*GeV)
t = Particle(zParity=+1,_name = 't+',_pid = 6,qColor = 3,eCharge = 2./3,
             spin = 1./2,mass = 173.21*GeV,_width = 1.41*GeV)
#1st generation leptons
e = Particle(zParity=+1,_name = 'e-',_pid = 11,qColor = 0,eCharge = -1,
             spin = 1./2, mass = 0.*GeV,_width = 0.*GeV)
ne = Particle(zParity=+1,_name = 'nue',_pid = 12,qColor = 0,eCharge = 0,
              spin = 1./2, mass = 0.*GeV,_width = 0.*GeV)
#2nd generation leptons
mu = Particle(zParity=+1,_name = 'mu-',_pid = 13,qColor = 0,eCharge = -1,
              spin = 1./2, mass = 0.106*GeV,_width = 0.*GeV)
nmu = Particle(zParity=+1,_name = 'numu',_pid = 14,qColor = 0,eCharge = 0,
               spin = 1./2, mass = 0.*GeV,_width = 0.*GeV)
#3rd generation leptons
ta = Particle(zParity=+1,_name = 'ta-',_pid = 15,qColor = 0,eCharge = -1,
              spin = 1./2, mass = 1.77*GeV,_width = 2.2e-12*GeV)
nta = Particle(zParity=+1,_name = 'nuta',_pid = 16,qColor = 0,eCharge = 0,
               spin = 1./2, mass = 0.*GeV,_width = 0.*GeV)
#Gauge bosons:
gluon = Particle(zParity=+1,_name = 'g',_pid = 21,qColor = 3,eCharge = 0,
                 spin = 1, mass = 0.*GeV,_width = 0.*GeV)
photon = Particle(zParity=+1,_name = 'photon',_pid = 22,qColor = 0,eCharge = 0,
                  spin = 1, mass = 0.*GeV,_width = 0.*GeV)
Z = Particle(zParity=+1,_name = 'Z',_pid = 23,qColor = 0,eCharge = 0,
             spin = 1, mass = 91.2*GeV,_width = 2.5*GeV)
W = Particle(zParity=+1,_name = 'W+',_pid = 24,qColor = 0,eCharge = +1,
             spin = 1, mass = 80.4*GeV,_width = 2.1*GeV)
#SM Higgs
higgs = Particle(zParity=1,_name = 'higgs',_pid = 25,qColor = 0,eCharge = 0,
                 spin = 0, mass = 125.*GeV,_width = 4.1e-3*GeV)
